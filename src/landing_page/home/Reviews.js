              ...
              <div className="card review-card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text text-center">
                    ...
                    someone here has been incredibly comforting. It's hard to
                    open up sometimes, but they make it so easy to share what's
                    on your mind. I always feel lighter after our conversations.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="card review-card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text text-center">
                    ...
                    difference. The support I received here has been so
                    comforting during some of my darkest days. It's amazing to
                    have a space where you can just be yourself without fear of
                    judgment.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-4 mb-4">
              <div className="card review-card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text text-center">
                    I was really struggling with loneliness, especially after
                    the pandemic. This service became my go-to whenever I felt
                    overwhelmed. Having someone listen to me made me feel seen
                    and heard for the first time in a long while.
                  </p>
                </div>
              </div>
            </div>
