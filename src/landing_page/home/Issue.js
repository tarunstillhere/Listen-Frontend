    ...
    <>
      <div className="issue-container">
        ...
        <div className="radial-div">
          <h2 className="issue-heading">Problems you can freely talk about</h2>
          ...
          <div className="slider-wrapper">
            <Slider {...settings}>
              ...
              <div className="slider-item">
                <div className="card">
                  <img
                    src="./media/images/1st.png"
                    alt="Career Uncertainty"
                    className="card-img"
                  />
                </div>
